...
2.  K Nearest Neighbors (KNN) <a id="knn"></a> - [KNN algorithms](https://www.youtube.com/watch?v=HVXime0nQeI) assign unknown data to a category based on what category its neighbors are listed as. For example, if you specify that k is 3, it will look at the classifications of the three closest points to the new data and tell you that your new data is the category that is the average value of the three points. If all three points belong to one category, your new point belongs to that category. If two points belong to one category it will also tell you that your new value belongs to that category.
